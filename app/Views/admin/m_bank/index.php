...
<div class="page-title">
    <h4>
        ...
        <span class="text-semibold">Home</span> - M_bank
...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
            <?php if(isset($edit)) : ?>
                <?php
                    $form::start(site_url('m_bank/update'));
                    $form::summernote();
...
<div class="modal" id="hapusmodal">
  <div class="modal-dialog">
    <form action="<?= site_url('m_bank/hapus')?>" method="post" enctype="">
