...
<div class="page-title">
    <h4>
        ...
        <span class="text-semibold">Home</span> - Type_status
...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
            <?php if(isset($edit)) : ?>
                <?php
                    $form::start(site_url('type_status/update'));
                    $form::summernote();
...
<div class="modal" id="hapusmodal">
  <div class="modal-dialog">
    <form action="<?= site_url('type_status/hapus')?>" method="post" enctype="">
