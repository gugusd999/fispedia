...
<div class="page-title">
    <h4>
        ...
        <span class="text-semibold">Home</span> - Kodeunik
...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
            <?php if(isset($edit)) : ?>
                <?php
                    $form::start(site_url('kodeunik/update'));
                    $form::summernote();
...
<div class="modal" id="hapusmodal">
  <div class="modal-dialog">
    <form action="<?= site_url('kodeunik/hapus')?>" method="post" enctype="">
