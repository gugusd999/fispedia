...
<?= $this->section('header') ?>
    <div class="page-title">
        <h4>
            ...
            <span class="text-semibold">Home</span> - InfoKilat
...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
            <?php if(isset($edit)) : ?>
                <?php
                    $form::start(site_url('InfoKilat/update'));
                    $form::summernote();
...
<div class="modal" id="hapusmodal">
  <div class="modal-dialog">
    <form action="<?= site_url('InfoKilat/hapus')?>" method="post" enctype="">
